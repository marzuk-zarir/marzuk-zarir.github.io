...
const Nav = styled.nav(({ isOpen }) => [
    tw`fixed bottom-0 inset-x-0 bg-zinc-50 text-gray-500 rounded-t-2xl transition-transform z-50`,
...
const Backdrop = tw.div`fixed inset-0 bg-black/60 transition-colors z-40`
